...
-(instancetype)init {
    ...
    TextFieldWithLabel *nameField = [[TextFieldWithLabel alloc] initWithLabel:@"Name" keyboardType:UIKeyboardTypeDefault];
    ...
    [collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo([portField mas_bottom]).offset(20);
        make.width.equalTo(self);
